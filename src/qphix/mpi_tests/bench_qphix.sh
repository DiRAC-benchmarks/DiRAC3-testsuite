...
for vol in  "-x 32 -y 32 -z 32 -t 32 " "-x 32 -y 32 -z 32 -t 64 " "-x 32 -y 32 -z 64 -t 64 " "-x 32 -y 64 -z 64 -t 64 " "-x 64 -y 64 -z 64 -t 64 "
do
  ...
  do
    ...
    do
      for c in `seq 16 -1 1`
      do
     	/cosma/home/dr002/dc-kash1/cosma5/DiRAC3-testsuite/src/qphix/build_soa4/tests/time_dslash_noqdp $vol $block -pxy 1 -pxyz 0 -c $c -sy 1 -sz 2 -minct $minct -compress12  -i 500 -prec f > /cosma5/data/dr002/dc-kash1/DiRAC3-testsuite/src/qphix/build_soa4/tests/soa4_bench/${x}.txt
